...
class Round
{
    ...
    protected function _generateSubRounds($attackerId, $defenderId, $attackCard, $defenseCard, $nextType = null)
    {
        $subRounds = array();
        if(is_null($nextType)){
        ...
        if($nextType == 'attack'){
            foreach($this->_remainCards[1] as $attackCard){
                foreach($this->_remainCards[2] as $defenseCard){
                    $subRounds = array_merge($subRounds, $this->_generateSubRounds(1, 2, $attackCard, $defenseCard, $nextType));
                }
            }
        } else {
            //TYPE IS DEFENSE
            foreach($this->_remainCards[2] as $attackCard){
                foreach($this->_remainCards[1] as $defenseCard){
                    $subRounds = array_merge($subRounds, $this->_generateSubRounds(2, 1, $attackCard, $defenseCard, $nextType));
                }
            }
        }
        return $subRounds;
